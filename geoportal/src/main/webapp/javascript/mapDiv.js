...
org.OpenGeoPortal.MapController.prototype.getCombinedBounds = function(arrBounds){
	...
	for (var currentBounds in arrBounds){
...
org.OpenGeoPortal.MapController.getSpecifiedExtent = function getSpecifiedExtent(extentType){
	//this code should be in mapDiv.js, since it has access to the openlayers object
	var extentMap = {"global": "-180,-90,180,90", "current": this.getGeodeticExtent().toBBOX(), 
			"maxforlayers": this.getLayerMaxExtent()};
